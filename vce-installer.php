...
(11, 'preloaded_components', '{"Input":"vce-application/components/input/input.php","File":"vce-application/components/file/file.php","Upload":"vce-application/components/upload/upload.php","Media":"vce-application/components/media/media.php","Breadcrumbs":"vce-content/components/breadcrumbs/breadcrumbs.php"}', ''),
